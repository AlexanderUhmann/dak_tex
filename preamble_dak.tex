...
\theoremstyle{definition} %  делает название теоремы обычным текстом
% plain выделяет заголовок курсивом
...
maxnames = 99,  % имена всех авторов выводит
%sorting = nyt,  % нумерация в алфавитном порядке 
sorting = none,  % нумерация по мере цитирования
]{biblatex}

\renewcommand*{\subtitlepunct}{\space} % Убирает двоеточие перед названием

% при каждом цитировании убираем addendum (Загл. с экрана)
\AtEveryCitekey{\clearfield{addendum}}
	
% фамилия потом инициалы
\DeclareNameAlias{default}{family-given}
\DeclareNameAlias{author}{default}

% убрать запятую между фамилией и инициалами
\renewcommand*{\revsdnamepunct}{\space}

% убирает пробел между инициалами
\renewcommand*{\bibinitdelim}{} 
\DeclareUnicodeCharacter{0084}{\textendash}


%\addbibresource{ref_8_02_2026.bib} % ref.bib - файл с библиографией
%\addbibresource{ref.bib}
\addbibresource{ref_.bib}
%-----------------гиперссылки
\usepackage{url}
\usepackage[   
    colorlinks=true,
